...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-16687504152">
</script>
<script>
...
<body>
    <div class="container">
        ...
        <h2>Effective Workout Routines</h2>
        <p>Discover our range of workout routines designed to target different areas of your body and help you build strength, endurance, and flexibility.</p>
        <img src="weights.jpg" alt="Weight Lifting">

        <h3>Strength Training</h3>
        <p>Engage in our resistance training programs to build lean muscle, boost metabolism, and improve overall body composition.</p>
        <img src="strength-training.jpg" alt="Strength Training">
